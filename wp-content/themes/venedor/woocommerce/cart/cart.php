			...
			if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
				...
				<tr class = "<?php echo esc_attr( apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					<td class="product-subtotal">
                        ...
                        <?php
                            echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf( '<a href="%s" class="btn-arrow remove" title="%s">&times;</a>', esc_url( WC()->cart->get_remove_url( $cart_item_key ) ), __( 'Remove this item', 'woocommerce' ) ), $cart_item_key );
                        ?>
                        </div>
                    </td>
				</tr>
    ...
    <div class="row">
            ...
            <div class="coupon-code">
                ...
                <div class="coupon">
                    ...
                    <p class="clearfix button-row">
                        <button class="button btn-lg" value="<?php _e( 'Apply', 'woocommerce' ); ?>" name="apply_coupon" type="submit"><?php _e( 'Apply', 'woocommerce' ); ?></button>
                    </p>
        ...
        <div class="col-md-5">
            ...
            <div class="proceed-buttons button-row">
                ...
                <button class="button btn-special wc-forward btn-lg" value="<?php _e( 'Proceed to Checkout &rarr;', 'woocommerce' ); ?>" name="proceed" type="submit"><?php _e( 'Proceed to Checkout', 'woocommerce' ); ?></button>
