...
global $woocommerce, $post, $product, $venedor_settings;
$displaytypenumber = 0;
                    ...
                    <td class="value"> <?php
                        ...
                        if (isset($attribute_display_type) && ($attribute_display_type  == "colororimage"))	{
                            ...
                            if ( sizeof($attributes) == $loop )
                                echo '<br /><a class="reset_variations reset_variations_color" href="#reset">' . __( 'Clear selection', 'wcva' ) . '</a>';
                        } elseif (isset($attribute_display_type) && ($attribute_display_type  == "radio"))  {
                            wcva_load_radio_select($name,$options,$selected_value);
                            if ( sizeof($attributes) == $loop )
                                echo '<br /><a class="reset_variations reset_variations_radio" href="#reset">' . __( 'Clear selection', 'wcva' ) . '</a>';
                        } else {
